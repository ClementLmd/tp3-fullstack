...
export default function LoginPage() {
  ...
  return (
    <div className="max-w-md mx-auto mt-12 p-8 bg-white rounded-2xl shadow-lg border border-gray-100">
      <h2 className="text-4xl font-extrabold mb-2 text-center bg-gradient-to-r from-blue-300 to-cyan-300 bg-clip-text text-transparent">
        Welcome back
      </h2>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          <label className="block mb-2 text-sm font-semibold text-blue-300">
            Email
          </label>
          <input
            type="email"
        ...
        {error && (
          <div className="text-red-400 text-sm font-medium bg-red-900/30 border border-red-500/50 p-3 rounded-lg">
            {error}
          </div>
        )}

      ...
      <div className="w-full max-w-4xl bg-gradient-to-br from-slate-800 via-slate-700 to-slate-800 rounded-2xl shadow-2xl p-10 border border-blue-400/30">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <h1 className="text-5xl font-extrabold mb-2 bg-gradient-to-r from-blue-300 to-cyan-300 bg-clip-text text-transparent">Quiz Platform</h1>
            {/* Subtitle in light gray */}
            <p className="text-slate-300">Real-time interactive quiz platform for teachers and students</p>
          </div>
          ...
          <div className="hidden md:block">
            ...
            {isAuthenticated ? (
              <div className="text-right bg-gradient-to-br from-blue-400/10 to-cyan-400/10 p-4 rounded-lg border border-blue-300/30">
                ...
                <p className="text-sm text-slate-200">Logged in as <span className="text-cyan-300 font-semibold">{user?.firstName} {user?.lastName}</span></p>
                {/* Display user role in blue */}
                <p className="text-sm text-slate-400">Role: <span className="text-blue-300 font-semibold">{user?.role}</span></p>
              ...
              <div className="flex gap-4">
                <Link href="/login" className="px-4 py-2 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-lg shadow hover:from-blue-700 hover:to-blue-800 transition">Log In</Link>
                <Link href="/signup" className="px-4 py-2 bg-gradient-to-r from-cyan-600 to-cyan-700 text-white rounded-lg shadow hover:from-cyan-700 hover:to-cyan-800 transition">Sign Up</Link>
              </div>
            )}
          </div>
        </div>
        ...
        {isAuthenticated && (
          <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="p-6 bg-gradient-to-br from-blue-500/20 to-cyan-500/10 rounded-lg border border-blue-400/50 hover:border-cyan-300 transition hover:shadow-lg">
              <h2 className="text-2xl font-bold mb-2 text-blue-300">Host a Quiz</h2>
              <p className="text-slate-300">Create and host live quizzes for your students with real-time interaction and instant feedback.</p>
            </div>
